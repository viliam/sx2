        ...
        TestTemplate<Program> tt =
            new TestTemplate<Program>(sb, new ProgramReader()) {
                ...
                public void nastavReader() {
                    ...
                    mr.dekPrikaz().setVystup(new DeklaraciaPrikaz(new DatovyTyp(new Slovo( new Pozicia(3,3))),
                                                                  new Slovo(null, "ahoj"), null, null));
                    mr.dekPrikaz().setPosun( 25, 0 );
                    mr.dekPremennej().setVystup(new DeklaraciaPremennej(
                            new DatovyTyp(new Slovo( new Pozicia(3,3))), new Slovo(null, "ahoj"), new Ciarka(null, SymbolEnum.BODKO_CIARKA)) );
