...
public class PodmienkaReader implements TextReader<Podmienka> {

    public Podmienka citaj(TextContext tC)        {
        ...
        return new Podmienka( akSlovo, vrzBool, instrukcia, z1, z2 );
    }
}
